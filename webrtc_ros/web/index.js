function onload() {
	...
	if(data_request.status == 200) {
		...
		var topic_list = document.createElement("ul");
		for(var topic_name in stream_data.camera_topics[base_topic]) {
		    ...
		    topic_a.appendChild(document.createTextNode(topic_name));
		    ...
		    topic_list.appendChild(topic_li);
		}
		camera_li.appendChild(topic_list);

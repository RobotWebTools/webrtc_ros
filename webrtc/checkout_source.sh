...
if [ -d opus_src ]; then (cd opus_src && git fetch); else (mkdir -p opus_src && git clone https://chromium.googlesource.com/chromium/deps/opus.git opus_src);fi; (cd opus_src && git checkout cae6961)
